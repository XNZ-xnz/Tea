...
- Wine 来源：Gcenx wine-crossover（GitHub Releases 官方 tar 包）；DXMT 来源：3Shain/dxmt Releases，安装方式以其 README 实测为准；D3DMetal：仅用户导入 GPTK dmg 提取（历史版本布局在 `redist/lib/`，GPTK 4 以实物为准）。
