...
- **阶段**：✅ P0-P3 完成；**降级完成 + 环境重建完成（macOS 26.5.2 / 25F84，Rosetta/Xcode26/gh 全就位）**；🏆 **CEF 黑屏彻底根治，Steam 完整 UI 正常渲染（27beta 噩梦终结）**；🏆 **Against the Storm 进入可交互主菜单 + 帧率打到 22.6 FPS（2026-07-24 下午，自建 DXVK，首款「能点自己界面」的游戏）**
...
**下一步**：draw call 提交开销是 MoltenVK 层课题，可试 DXVK 侧 `d3d11.cachedDynamicResources`、
或等 MoltenVK 演进。22.6 FPS 对这类慢节奏建造经营游戏已接近可玩，进游戏内实战再测一轮才好定徽章档位。
